...
> **Dokumen pasangan:** `2026-09-06_UXVisualTechnical_v1.0.md` (implementasi teknis)
...
> **belum ada** di backend saat ini (lihat `2026-09-06_UXVisualTechnical_v1.0.md` §3 untuk daftar API
...
- Toolbar alat gambar di kiri (crosshair, garis trend, dll.) — **opsional/fase lanjutan**, tidak
  ...
  tersendiri (lihat `2026-09-06_UXVisualTechnical_v1.0.md` §5).
...
- `2026-09-06_UXVisualTechnical_v1.0.md` — struktur route, komponen, dan API baru yang dibutuhkan.
