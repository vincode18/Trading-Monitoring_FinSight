...
> `Environment/2026-09-06_DatabaseSupabase_v1.1.md` (model `User` sudah tersedia)
...
`Environment/2026-09-06_DatabaseSupabase_v1.1.md` — enhancement ini hanya perlu
...
- [ ] Update `frontend/` — form login/register sederhana (bisa reuse UI shell dari
      `Environment/2026-09-06_UXVisual_v1.0.md` §4.3) + simpan token di `localStorage` untuk
...
| `frontend/` (komponen baru) | Baru | Form login/register (lihat §4.3 `2026-09-06_UXVisual_v1.0.md`) |
...
- **`JWT_SECRET_KEY` wajib digenerate ulang** kalau pernah tidak sengaja ter-commit/terekspos di
  ...
  `Environment/2026-09-06_DatabaseSupabase_v1.1.md` §6 untuk password database.
...
- `Environment/2026-09-06_DatabaseSupabase_v1.1.md` — model `User`/`Role` yang dipakai.
- `Environment/2026-09-06_UXVisual_v1.0.md` §4.3 — desain UI Login/Sign Up.
- `Environment/2026-09-06_UXVisualTechnical_v1.0.md` §5 — catatan bahwa OAuth (Google/Apple/Microsoft)
